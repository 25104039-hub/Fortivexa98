...
- `documentation/model_card.md` - model card (inputs, features, limitations)
- `documentation/TRL5_SYSTEM_ARCHITECTURE.md` - system architecture
- `server/data/metrics.json` - benchmark metrics

Run locally: `npm install` then `npm run dev` (API on :5001, app on :5173).
